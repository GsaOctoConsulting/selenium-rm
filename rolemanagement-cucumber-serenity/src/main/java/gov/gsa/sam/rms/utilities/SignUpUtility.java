...
/**
 * Description: this class provides method/s to take a user through
 * the signup process and take them to the CommonProfile page of SAM webpage environment
 * 
 * @author Raiaan
 *
 */
public class SignUpUtility {
	 ...
	 * @param useremail fed useremail that will be used to signup. e.g travis@gsa.gov
	...
	public static String signUpNewUser(String useremail, String password) throws Exception {
		...
		if (Constants.SIGNUP_SECURITYLEVEL.equals("IAL2")) {
			...
			LaunchBrowserUtil.driver.findElement(By.xpath("//*[@id=\"new_two_factor_options_form\"]/div[1]/fieldset/label[2]/div/span[1]"))
					.click();
			LaunchBrowserUtil.delay(2);
			LaunchBrowserUtil.driver.findElement(By.className("btn-primary")).click();
			LaunchBrowserUtil.delay(2);
			...
			LaunchBrowserUtil.driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/ul/li[3]/div[2]/form/div/div[2]/input")).click();
			LaunchBrowserUtil.delay(2);
			LaunchBrowserUtil.driver.findElement(By.className("btn-primary")).click();
			LaunchBrowserUtil.delay(5);
			LaunchBrowserUtil.driver.findElement(By.xpath("//*[@id=\"new_two_factor_options_form\"]/div[1]/fieldset/label[1]/div/span[1]")).click();
			LaunchBrowserUtil.delay(1);
			LaunchBrowserUtil.driver.findElement(By.xpath("//*[@id=\"new_two_factor_options_form\"]/div[2]/input")).click();
			LaunchBrowserUtil.delay(2);
			...
			RequestRoleOptionalPage.setDriver(LaunchBrowserUtil.getDriver());// passing reference to requestroleoption page
		}
		return secretCode;
	}
	/**
	 ...
	 * @param useremail nonfed useremail that will be used to signup. e.g john@gmail.com
	 * @param password the desired password for this account
	 * @return
	 * @throws Exception
	 */
