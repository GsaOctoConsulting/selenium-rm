...
public class T1WorkspacePageLocator {
	...
	public static final By FH_WIDGET = By.tagName("sam-workspace-fh-widget");
	public static final By UPLOAD_AAC_WIDGET = By.tagName("sam-workspace-upload-aac-widget");
