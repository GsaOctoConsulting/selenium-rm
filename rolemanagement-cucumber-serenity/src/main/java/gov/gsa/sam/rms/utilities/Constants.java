...
public class Constants {
	...
	// urls
	//public static final String SAM_HOME_PAGE = "https://alpha.sam.gov";
	...
	public static final String ORG_COCACOLA_BOTTLINGCOMPANY_OFNORTHERNNEWENGLAND = "COCA-COLA BOTTLING COMPANY OF NORTHERN NEW ENGLAND, INC, THE"
			.toUpperCase();
	public static final String ORG_IBMSOUTHEAST_EMPLOYEES_CREDITUNION = "IBM SOUTHEAST EMPLOYEES' CREDIT UNION".toUpperCase();
	public static final String ORG_MULTIPLE_ENTITIES = "multiple Entities";
	// Org Codes
	...
	static {
		if (Constants.SAM_HOME_PAGE.contains("comp")) {
			...
			API_URL_PENDINGHIERARCHY_APPROVE = "https://api-nonprod.prod-iae.bsp.gsa.gov/comp/rms/v1/access/pendinghierarchy/approve";
			API_URL_PENDINGHIERARCHY_REJECT = "https://api-nonprod.prod-iae.bsp.gsa.gov/comp/rms/v1/access/pendinghierarchy/reject";
	...
	public static final String ROLE_DRAFTREGISTRATION_USER = "Draft Registration User";
