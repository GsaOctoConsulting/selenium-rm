...
Scenario: system account admin should be able to reorder uploaded files
	...
	Given _1 system account admin enters all the organization info 
	And _1 system account admin enters permissions info 
	And _1 system account admin enters security info 
	And _1 system account admin enters autohorization info and select files to upload
	When _1 system account admin reorders the files
	Then _1 attachements should be reordered for system account files