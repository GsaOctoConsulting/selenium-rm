...
@16 
Scenario:
when a role is updated for a nonfed user then user should see role updated status in profile history 
...
@17 
Scenario:
when user is being assigned a role that they already have proper error message should display 
...
@18 
Scenario:
a nonfed admin in a particular domain when requesting a role should not see any role options under that domain 
...
@19 
Scenario:
a new nonfed users pending request should diplay with accurate info in spaads 
...
@20 @temp 
Scenario:
user directory search box should give expected list of users for nonfed user 
...
@21 @ww 
Scenario:
user directory search box should give expected list of users with entity specific emails for nonfed user 
...
@22 @ww 
Scenario:
user directory entiy search should give expected list of orgs with name duns and cage code for nonfed admin 
