...
additionalemailid=SignInUtility.signIntoLogindotgov(ConstantsAccounts.NO_ROLE_USER_7_EMAIL_VARIANCE, Constants.USERPASS,
		ConstantsAccounts.NO_ROLE_USER_5_EMAIL_VARIANCE_SECRETKEY,Constants.ADD_EMAIL);
	   
	}

	@Given("^_1ev user register a second email in the account which was not associated previously$")
	public void _1_ev_user_register_a_second_email_in_the_account_which_was_not_associated_previously() throws Exception {
...
String splashpageheading= T1WorkspacePage.getSplashPageHeading();
	...
	public void _1_ev_user_should_receives_additional_modals_before_landing_into_workspace() throws Exception {
	  T1WorkspacePage.goToAccountDetailsPage();
	   LaunchBrowserUtil.closeBrowsers();
	   //-----------------------delete the added email to set it back-------------------------------
	   SignInUtility.signIntoLogindotgov(ConstantsAccounts.NO_ROLE_USER_7_EMAIL_VARIANCE, Constants.USERPASS,
				ConstantsAccounts.NO_ROLE_USER_5_EMAIL_VARIANCE_SECRETKEY,Constants.DELETE);
