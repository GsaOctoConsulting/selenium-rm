...
public class LoginStep {
	...
	public void _1_user_already_has_dra_account_setup_and_enters_and(String arg1, String arg2) throws Throwable {
		SignInUtility.signIntoWorkspace(ConstantsAccounts.NONFED_ENTITYADMIN_ENTITYREGISTRATIONI_OCTO_DATAENTRY_CONTRACTOPP_IBM, Constants.USERPASS,
				ConstantsAccounts.NONFED_ENTITYADMIN_ENTITYREGISTRATIONI_OCTO_DATAENTRY_CONTRACTOPP_IBM_SECRETKEY, Constants.USER_FED);
...
//		LaunchBrowserUtil.delay(4);
//		SignInUtility.signIntoWorkspace(ConstantsAccounts.NONFED_MULTIPLEENTITIES_ADMIN_ENTITYREGISTRATION, Constants.USERPASS,
//				ConstantsAccounts.NONFED_MULTIPLEENTITIES_ADMIN_ENTITYREGISTRATION_SECRETKEY, Constants.USER_NONFED);
//		LaunchBrowserUtil.delay(4);
...
// SignUpUtility.signUpNewUserNonFedTemporary("raiaan.zyx+newregisterednonfeduser"
	...
	public void _9_user_should_see_feeds_notifications_for_the_role_requested() throws Throwable {
		...
		boolean requestFound = FeedsRequestPage.requestFound("You", Constants.ORG_GSA, Constants.ROLE_ASSISTANCE_USER,
				Constants.DOMAIN_ASSISTANCE_LISTING, "", Constants.STATUS_PENDING, Constants.REJECTROLE);
